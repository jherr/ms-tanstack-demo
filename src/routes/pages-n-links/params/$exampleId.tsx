...
export const Route = createFileRoute('/pages-n-links/params/$exampleId')({
  ...
  return (
    <main className="page-wrap px-4 pb-8 pt-14">
      <section className="island-shell rounded-2xl p-6 sm:p-8">
        <p className="island-kicker mb-2">Parameterized route</p>
        <h1 className="display-title mb-3 text-4xl font-bold text-[var(--sea-ink)] sm:text-5xl">
          Dynamic segment
        </h1>
        <p className="mb-4 text-base text-[var(--sea-ink-soft)]">
          File: <code className="rounded bg-[var(--chip-bg)] px-1.5 py-0.5 text-sm">pages-n-links/params/$exampleId.tsx</code>.
          Param <code className="rounded bg-[var(--chip-bg)] px-1.5 py-0.5 text-sm">exampleId</code> is type-safe in loaders and components.
        </p>
        ...
        <p className="mb-6">
          <a
            href={`${ROUTING_GUIDE}#defining-routes`}
            target="_blank"
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Link
            to="/pages-n-links/params/$exampleId"
            params={{ exampleId: 'other' }}
            className="rounded-full border border-[rgba(50,143,151,0.3)] bg-[rgba(79,184,178,0.14)] px-4 py-2 text-sm font-semibold text-[var(--lagoon-deep)] no-underline transition hover:-translate-y-0.5 hover:bg-[rgba(79,184,178,0.22)]"
          >
            Go to /params/other
          </Link>
